...
<head>
  ...
  <title><?php echo $techr; ?> Time Table</title>
  <link rel="stylesheet" href="html/scss/style.css" />
</head>

<body>
  <header><?php echo $techr; ?> Time Table</header>
  <div>
        ...
        <div class="row">
          ...
          ?>
            <div class="cell">
              ...
              // i -> lec
              // row[days] -> mon...
              if (!$tt->isCellNull($techr, 'Lecture_No', $i, $row['days'])) {
                $cellData = $tt->getData($techr, 'Lecture_No', $i, $row['days']);
